...
Then we executed a chi-square test to know if the results are significant. The value of the chi-square is very high and the P-value very small. Therefore our results are significant and we can reject the null hypothesis of independece between the two variables.
